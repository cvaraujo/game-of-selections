...
public class Pesquisa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String prof = request.getParameter("procurar_prof");
        String titulo = request.getParameter("procurar_titulo");
        String area = request.getParameter("procurar_area");
        ...
        DaoSelecao selecao = new DaoSelecao();
        ...
        ArrayList<Selecao> retorno = selecao.entreDatas(dataI, dataF, prof, titulo, area);
        
        request.getSession().setAttribute("selecoes", retorno);
