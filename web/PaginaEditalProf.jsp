    ...
    <body>
        ...
        <div class="jumbotron">
            <div class= row>
                ...
                <p></p>
                <div>
                    <% session.setAttribute("Ultimolocal", "http://localhost:8080/GameOfSelections" + request.getServletPath());%>

                    <form action="AssociarProfAvaliador.jsp" method="post">
                        <button type = "submit" class="btn btn-info btn-default">
                            Associar avaliadores às etapas
                        </button>
                    </form>
                    <p></p>
                    <form action="Aprovados" method="post">
                        <button type = "submit" class="btn btn-info btn-default">
                            Verificar ranking
                        </button>
                    </form>
